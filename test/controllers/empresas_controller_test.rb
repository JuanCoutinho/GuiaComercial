...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference("Empresa.count") do
      post empresas_url, params: { empresa: { descricao: @empresa.descricao, nome: @empresa.nome } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { descricao: @empresa.descricao, nome: @empresa.nome } }
